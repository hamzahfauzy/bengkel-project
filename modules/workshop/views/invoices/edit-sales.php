      ...
      <div class="row">
        <div class="col-12 col-md-6">
          ...
          <div class="row mb-3">
              ...
              <div class="col-8">
                  <textarea name="ws_invoices[description]" class="form-control"><?=$sales->description?></textarea>
              </div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          ...
          <tbody>
            <?php foreach ($sales->items as $index => $item): ?>
              <tr id="item_<?= $index + 1 ?>">
                ...
                <td><input type="number" class="form-control discount-input" style="width:100px" name="items[<?= $index ?>][total_discount]" value="<?= $item->total_discount ?>" data-key="<?= $index + 1 ?>">
