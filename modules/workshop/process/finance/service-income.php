...
$db->query = "SELECT 
              ...
              LEFT JOIN ws_invoice_items ON ws_invoice_items.invoice_id = ws_payments.invoice_id
              LEFT JOIN ws_products ON ws_products.id = ws_invoice_items.product_id
              WHERE ws_payments.record_type = 'IN' AND ws_payments.created_at BETWEEN '$start_month' AND '$end_month'
              GROUP BY bulan
              ORDER BY bulan";
...
Page::setActive("workshop.ws_service_income");
Page::setTitle($title);
...
return view('workshop/views/finance/service-income', compact('omset','graphic','services'));